...
void BinaryUFunc(const char** args, npy_intp const* dimensions, npy_intp const* steps,
                 void* data) {
...
void CompareUFunc(const char** args, npy_intp const* dimensions, npy_intp const* steps,
                  void* data) {
